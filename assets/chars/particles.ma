...
//Name: particles.ma
//Last modified: Tue, May 05, 2015 10:01:16 PM
//Codeset: UTF-8
requires maya "2015";
...
createNode particle -n "particleShape1" -p "particle1";
	...
	setAttr ".usc" yes;
	setAttr ".scp" -type "string" "particles_startup";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 51.81030799753249 38.857730998149393 51.810307997532519 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -5.172681101354183e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 82.936959721965337;
...
createNode animCurveTU -n "ramp1_colorEntryList_0__position";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  80 1 82 0.96699672937393188 94 0.91749173402786255
		 106 0.72607260942459106 118 0.47524753212928772 136 0.31683167815208435;
createNode animCurveTU -n "ramp1_colorEntryList_2__position";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  80 1 82 0.98349833488464355 94 0.93069308996200562
		 106 0.74257427453994751 118 0.49174916744232178 136 0.33663365244865417;
createNode animCurveTU -n "ramp1_colorEntryList_3__position";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  80 0.99009901285171509 82 0.96369636058807373
		 94 0.90099012851715088 106 0.70297032594680786 118 0.4455445408821106 136 0.29372936487197876;
...
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min -10 -max 136 -ast -10 -aet 144 ";
	setAttr ".st" 6;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
...
connectAttr "layerManager.dli[1]" "Meshes.id";
connectAttr "lambert2SG.msg" "materialInfo6.sg";
connectAttr "lambert2.msg" "materialInfo6.m";
connectAttr "ramp1.msg" "materialInfo6.t" -na;
connectAttr "lambert2.oc" "lambert2SG.ss";
connectAttr "ramp1.oc" "lambert2.c";
connectAttr "place2dTexture1.o" "ramp1.uv";
connectAttr "place2dTexture1.ofs" "ramp1.fs";
connectAttr "ramp1_colorEntryList_0__position.o" "ramp1.cel[0].ep";
connectAttr "ramp1_colorEntryList_2__position.o" "ramp1.cel[2].ep";
connectAttr "ramp1_colorEntryList_3__position.o" "ramp1.cel[3].ep";
...
connectAttr "uiConfigurationScriptNode.msg" "hyperLayout1.hyp[10].dn";
connectAttr "sceneConfigurationScriptNode.msg" "hyperLayout1.hyp[11].dn";
